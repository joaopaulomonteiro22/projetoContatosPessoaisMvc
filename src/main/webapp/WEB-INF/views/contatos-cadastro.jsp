	...
	<div class="row mt-3">
		<div class="col-md-4 offset-md-4">
			<div class="card ">
				...
				<div class ="mt-2">
					 <input type ="submit" value ="cadastrar" class =" text-light form-control bg-primary" >
				
				
				
				</div>
					<div>
					<a href ="/projetoFinal01/edicao" class ="btn btn-light form-		control">edite contatos<strong>clique aqui !</strong></a>
